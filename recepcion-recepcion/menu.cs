...
namespace LND
{
    public partial class menu : Form
    {
       ...
       string codigo_usuario__;
        ...
        private void basesUtilizadasAsignadasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            nombre_informe = "BASES UTILIZADAS";
            informe_ = "[LDN].[BASES_UTILIZADAS]";
            Informes informe = new Informes();
        ...
        {
            CLIC crear_clic = new CLIC();
            crear_clic.Show();
        }

        private void descargaBodegaProduccionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Taspaso_bodegas crear_clic = new Taspaso_bodegas();
            crear_clic.Show();
        }
    }
}
